...
const JoinForm = () => {
    ...
    const emailCheckHandler = async (email) => {
        ...
        try {
            ...
            const response = await axios.post(`${REACT_APP_API_URL}/join/validEmail`, emailData, config);
    ...
    const idCheckHandler = async (id) => {
        ...
        try {
            ...
            const response = await axios.post(`${REACT_APP_API_URL}/join/validId`, idData, config);
            if (response.data === true) {
    ...
    const onSubmitHandler = async (e) => {
        ...
        if (finalValidation() === true) {
            await axios
                .post(`${REACT_APP_API_URL}/join/joinNewUser`, joinData, config)
                .then((response) => {
                    if (response.data === true) {
                        alert("회원가입에 성공하셨습니다.");
                        navigate("/login");
