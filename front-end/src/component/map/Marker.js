...
import { positions } from '../../data/MarkerPositions';
import { createElement } from 'react';

const { kakao } = window;

const imageSrc = markerImagePng// 마커이미지의 주소입니다    
const imageSize = new kakao.maps.Size(28, 34)// 마커이미지의 크기입니다
...
let markerContent = '<div class="wrap">' +
    '    <div class="info">' +
    '        <div class="title">' +
    '            세종대학교 학식' +
...
export const marker = new kakao.maps.Marker({
    ...
    //         <MapMarker
    //             key={`${positions.title}-${position.latlng}`}
